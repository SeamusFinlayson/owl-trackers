  ...
  return (
    <div className={mode === "DARK" ? "dark" : ""}>
      <div className="grid grid-cols-[minmax(120px,_auto)_repeat(3,_42px)] items-center p-4">
        <p className="m-0 text-lg font-bold tracking-[0px] text-text-primary dark:text-text-primary-dark">
          Owl Trackers
        </p>
      ...
      <div className="flex w-full flex-col gap-3 p-4 pt-3">
        {role === "PLAYER" ? (
          <h1 className="justify-self-start text-sm text-text-secondary dark:text-text-secondary-dark">
          ...
          <div className="grid w-full grid-cols-[auto_50px] items-center justify-items-end gap-x-1 gap-y-4">
            <h1 className="justify-self-start text-sm text-text-primary dark:text-text-primary-dark">
